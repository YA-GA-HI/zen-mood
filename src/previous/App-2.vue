...
<main id="songs">
  <div v-for="song in songs" :key="song" :class="{'song-bg':true , 'song-bg-played': song.played }">
    <button class="song" @focus="play(song.name)" :ref="song.name" >
      ...
      <svg class="float" v-html="song.icon" xmlns="http://www.w3.org/2000/svg"  width="50%" height="50%" viewBox="0 0 24 24" stroke-width="1.5" stroke="var(--icon)" fill="none" stroke-linecap="round" stroke-linejoin="round">
      </svg>
...
export default {
  ...
  <path d="M9.5 15.25a3.5 3.5 0 0 1 5 0" />`
      ...
      songs:[
        ...
        <path d="M12 12c2 -2.96 0 -7 -1 -8c0 3.038 -1.773 4.741 -3 6c-1.226 1.26 -2 3.24 -2 5a6 6 0 1 0 12 0c0 -1.532 -1.056 -3.94 -2 -5c-1.786 3 -2.791 3 -4 2z" />`,
          ...
          audio: new Audio( require("./assets/campfire.wav") ),
          played:false,
        },
  ...
  <path d="M11 13v2m0 3v2m4 -5v2m0 3v2" />`,
          tags:["relax","sadness"],
          audio: new Audio( require("./assets/rain.wav") ),
          played:false,
        },
  ...
  <path d="M4 16h5.5a2.5 2.5 0 1 1 -2.34 3.24" />`,
          ...
          audio: new Audio( require("./assets/winds.wav") ),
          played:false,
        },
  ...
  <path d="M19 10c.638 -.636 1 -1.515 1 -2.486a3.515 3.515 0 0 0 -3.517 -3.514c-.97 0 -1.847 .367 -2.483 1m-3 13l4 -4l4 -4" />`,
          tags:["focus"],
          audio: new Audio( require("./assets/birds.wav") ),
          played:false,
        },
  ...
  <line x1="10" y1="14" x2="14" y2="14" />`,
          tags:["relax","sadness"],
          audio: new Audio( require("./assets/keyboard.wav") ),
          played:false,
        },
  ...
  <path d="M9 18c6.218 0 10.5 -3.288 11 -12v-2h-4.014c-9 0 -11.986 4 -12 9c0 1 0 3 2 5h3z" />`,
          tags:["relax"],
          audio: new Audio( require("./assets/forest.wav") ),
          played:false,
        },
  ...
  <polyline points="13 14 11 18 14 18 12 22" />`,
          ...
          audio: new Audio( require("./assets/lightning.wav") ),
          played:false,
        },
  ...
  <line x1="9" y1="18" x2="9" y2="18.01" />`,
          tags:["productivity"],
          audio: new Audio( require("./assets/office.wav") ),
          played:false,
        },
  ...
  <path d="M18 5h-1a1 1 0 0 0 -1 1v4" />`,
          tags:["focus"],
          audio: new Audio( require("./assets/farm.wav") ),
          played:false,
        },
  ...
  <path d="M3 12c3 -2 6 -2 9 0s6 2 9 0" />`,
          ...
          audio: new Audio( require("./assets/ocean.wav") ),
          played:false,
        },
  ...
  <circle cx="17" cy="5" r="1" />`,
          tags:["focus","sadness"],
          audio: new Audio( require("./assets/bike.wav") ),
          played:false,
        },
  ...
  <path d="M19 11h2m-1 -1v2" />`,
          tags:["sadness"],
          audio: new Audio( require("./assets/night.wav") ),
          played:false,
        },
  ...
  <line x1="4" y1="9" x2="7.5" y2="12.5" />`,
          tags:["relax"],
          audio: new Audio( require("./assets/st-wars.mp3") ),
          played:false,
        },
  ...
  <polyline points="12 16 12 11 14 12" />`,
          tags:["productivity"],
          audio: new Audio( require("./assets/lofi.mp3") ),
          played:false,
        },
  ...
  <path d="M16 12v1.5a2.5 2.5 0 0 0 5 0v-1.5a9 9 0 1 0 -5.5 8.28" />`,
          tags:[],
          audio: new Audio( require("./assets/anime.mp3") ),
          played:false,
        },
  ...
  <line x1="3" y1="19" x2="21" y2="19" />`,
          tags:["focus"],
          audio: new Audio( require("./assets/train.wav") ),
          played:false,
        },
  ...
  <polyline points="12 7 12 12 15 15" />`,
          tags:[],
          audio: new Audio( require("./assets/clock.wav") ),
          played:false,
        },
  ...
  <path d="M12 3v6l3 -3m-6 0l3 3" />`,
          tags:["relax"],
          audio: new Audio( require("./assets/morning.wav") ),
          played:false,
        },
  ...
  <path d="M12 7v-4m3 13l2.5 3m-.74 -8.55l3.74 -1.45m-11.44 7.05l-2.56 2.95m.74 -8.55l-3.74 -1.45" />`,
          tags:[],
          audio: new Audio( require("./assets/stadium.wav") ),
          played:false,
        },
  ...
  <line x1="3" y1="21" x2="21" y2="21" />`,
          tags:[],
          audio: new Audio( require("./assets/airport.wav") ),
          played:false,
        },
...
.song-bg:hover{
  box-shadow: 0px 0px 7px var(--secondary) ,
              0px 0px 14px var(--secondary),
              0px 0px 28px var(--secondary);
}
...
/* .song-bg:hover{
  box-shadow: 0px 8px 10px var(--info);
} */
